                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div><?= $this->session->flashdata('message'); ?></div>
                            <div>
                                <a href="<?= base_url(); ?>penjual/pendaftaran" class="btn bg-indigo waves-effect">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if ($p['status_pengajuan'] == "Menunggu Respon") {
                                                    ?> <span class="badge bg-orange">Menunggu Respon</span><?php
                                                                                                        } elseif ($p['status_pengajuan'] == "Verifikasi Berkas Berhasil") { ?>
                                                        <span class="badge bg-green">Verifikasi Berkas Berhasil</span>
                                                    <?php
                                                                                                        } elseif ($p['status_pengajuan'] == "Selesai") { ?>
                                                        <span class="badge bg-green">SELESAI</span>
                                                    <?php
                                                                                                        }elseif ($p['status_pengajuan'] == "Berkas Diperiksa") { ?>
                                                        <span class="badge bg-cyan">Berkas Diperiksa</span>
                                                    <?php
                                                        ...
                                                        <span class="badge bg-green">Berkas Terverifikasi</span><?php
                                                                                                                ...
                                                                                                                ?><span class="badge bg-red">Ditolak</span><?php
                                                                                                                                                            ...
                                                                                                                                                            ?><span class="badge bg-cyan">Menunggu Verifikasi Pajak</span><?php
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            ?><span class="badge bg-indigo">Peninjauan</span><?php
                                                ...
                                                <td><?= $p['alasan']; ?></td>
                                                <td><a href="<?= base_url(); ?>penjual/detail/<?=$p['no_pengajuan'];?>" class="btn bg-blue"><i class="material-icons">remove_red_eye</i> Detail</a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
