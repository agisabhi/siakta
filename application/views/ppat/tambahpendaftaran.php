                        ...
                        <div class="body">
                            <div id="smartwizard">
                                ...
                                <ul class="nav">
                                    ...
                                    <form enctype="multipart/form-data" method="POST" action="" id="formpengajuan">
                                        ...
                                        <h3>Data Jual Beli</h3>
                                                ...
                                                <div class="form-group form-float">
                                                    <div class="form-line">
                                                        <input type="text" name="harga_transaksi" id="harga_transaksi" class="form-control" required>
