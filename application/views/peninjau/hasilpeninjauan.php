                        ...
                        <div class="card profile-card">
                            <div class="profile-footer">
                                <?php foreach ($verifikasi as $p) : ?>
                                    ...
                                    <a href="<?= base_url(); ?>peninjau/editverifikasi/<?= $p['no_jadwal']; ?>" class="btn btn-info btn-lg waves-effect btn-block">Edit</a>
                                    <a href="<?= base_url(); ?>peninjau/jadwalpeninjauan" class="btn btn-danger btn-lg waves-effect btn-block">Back</a>
                                <?php endforeach; ?>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card profile-card">
                            <div class="profile-footer">
                                <?php foreach ($berita as $p) : ?>
                                    ...
                                    <a href="<?= base_url(); ?>peninjau/editberita/<?= $p['no_jadwal']; ?>" class="btn btn-info btn-lg waves-effect btn-block">Edit</a>
                                    <a href="<?= base_url(); ?>peninjau/jadwalpeninjauan" class="btn btn-danger btn-lg waves-effect btn-block">Back</a>
                                <?php endforeach; ?>
                            </div>
                        </div>
