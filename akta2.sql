...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2021 at 07:34 AM
...
(17, 100, 'Tanah a.n Abi', 'Tanah a.n H. Sapta', 'masjid ar-rahmah', 'tanah wakaf dzikri', 1, 'SERTIFIKAT1.jpeg'),
(18, 100, 'masjid al-latif', 'tanah as-syidkur', 'al-furqon', 'Mushola', 13, 'sertifikat6.jpg');
...
(13, '2021-08-28', 'P2021080017', '10517073');
...
CREATE TABLE `pajak` (
  ...
  `nominal_pajak` varchar(50) NOT NULL,
  `ssb` varchar(50) NOT NULL,
...
INSERT INTO `pajak` (`id_pajak`, `billing_pajak`, `nominal_pajak`, `ssb`, `bukti_transfer`, `no_pengajuan`) VALUES
...
(5, 80992299, '1.750.000', '1.150.000', 'WhatsApp_Image_2021-06-25_at_15_37_112.jpeg', 'P2021060006'),
(6, 2147483647, '1250000', '', 'WhatsApp_Image_2021-06-25_at_15_37_113.jpeg', 'P2021070008'),
(7, 892200119, '985.000', '300.000', 'WhatsApp_Image_2021-07-05_at_11_19_095.jpeg', 'P2021060005'),
(8, 2147483647, '1.250.000', '550.000', 'Kwitansi-Jual-Beli-Tanah-6-11.jpg', 'P2021070009'),
(9, 2147483647, '1750000', '', 'Screenshot_(2).png', 'P2021080012'),
(10, 2147483647, '1750000', '', 'pajak2.jpeg', 'P2021080013'),
(11, 2147483647, '1.800.000', '1.200.000', 'pajak22.jpeg', 'P2021080016'),
(12, 1982001199, '3.875.000', '2.700.000', 'pajak23.jpeg', 'P2021080017');
...
(2891889992001199, 'Saptinah', 'Kp rambutan raya no 124', 2147483647, 'Ktp-Penjual5.jpg', 'npwp-pembeli5.jpg'),
(1239723863688111, 'sadasdw', 'dojs', 2147483647, 'Ktp-Pembeli9.jpg', 'npwp-pembeli6.jpg');
...
CREATE TABLE `pendaftaran` (
  ...
  `harga_transaksi` varchar(50) NOT NULL,
...
('P2021080017', '2021-08-27', 1802901100220003, 2891889992001199, 18029933001902, '190.000.000', 'kuitansi-tanah5.png', '', 'Penjadwalan Pengambilan', 1),
('P2021080018', '2021-08-27', 1002909120808139, 1239723863688111, 99100299138081, '185.750.000', 'kuitansi-tanah6.png', '', 'Berkas Terverifikasi', 20);
...
(1802901100220003, 'Jumadil Akagara', 'Antapani no 12', '081922772819', 2147483647, 'format_output5.jpg', 'Shopee_5ec955b9a840e9f1d92ae6f3e2a0f54f1.jpg'),
(1002909120808139, 'jijisad', 'asdas', '081297386126', 2147483647, 'Ktp-Penjual6.jpg', 'npwp-penjual4.JPG');
...
(18029933001902, 'Jumadil Akagara', 100, 'Cilengkran 2, No 190', 'SERTIFIKAT.jpeg'),
(99100299138081, 'asdokoasd', 109, 'kasdiosh', 'sertifikat7.jpg');
...
--
ALTER TABLE `jadwal`
  MODIFY `no_jadwal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `verifikasi`
  MODIFY `no_verifikasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
